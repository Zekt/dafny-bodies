// Dafny 2.3.0.10506
// Command Line Options: /print:MultiReturns.bpl /useSmtOutputFormat MultiReturns.dfy
...
procedure CheckWellformed$$_module.__default.MultipleReturns(x#0: int, y#0: int) returns (more#0: int, less#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$_module.__default.MultipleReturns(x#0: int, y#0: int) returns (more#0: int, less#0: int);
...
procedure Impl$$_module.__default.MultipleReturns(x#0: int, y#0: int) returns (more#0: int, less#0: int, $_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  // user-defined preconditions
  requires 0 < y#0;
  modifies $Heap, $Tick;
...
implementation Impl$$_module.__default.MultipleReturns(x#0: int, y#0: int) returns (more#0: int, less#0: int, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    assume {:captureState "MultiReturns.dfy(5,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- MultiReturns.dfy(6,8)
    assume true;
    assume true;
    more#0 := x#0 + y#0;
    assume {:captureState "MultiReturns.dfy(6,15)"} true;
    // ----- assignment statement ----- MultiReturns.dfy(7,8)
    assume true;
    assume true;
    less#0 := x#0 - y#0;
    assume {:captureState "MultiReturns.dfy(7,15)"} true;
}
