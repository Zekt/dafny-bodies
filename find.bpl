// Dafny 2.3.0.10506
// Command Line Options: /print:find.bpl find.dfy
...
implementation CheckWellformed$$_module.__default.Find(a#0: ref, key#0: int) returns (index#0: int)
{
  ...
  var k#0: int;
    ...
    assume {:captureState "find.dfy(1,7): initial state"} true;
    havoc $Heap;
    ...
    havoc index#0;
    assume {:captureState "find.dfy(2,22): post-state"} true;
    if (*)
    {
...
implementation Impl$$_module.__default.Find(a#0: ref, key#0: int) returns (index#0: int, $_reverifyPost: bool)
{
  ...
  var $decr$loop#00: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "find.dfy(4,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- find.dfy(5,10)
    assume true;
    assume true;
    index#0 := LitInt(0);
    assume {:captureState "find.dfy(5,13)"} true;
    // ----- while statement ----- find.dfy(6,4)
    ...
    while (true)
      ...
      invariant $w$loop#0
         ==> (forall k#3: int :: 
          ...
          true
             ==> 
            LitInt(0) <= k#3 && k#3 < index#0
             ==> $Unbox(read($Heap, a#0, IndexField(k#3))): int != key#0);
    ...
    {
        assume {:captureState "find.dfy(6,3): after some loop iterations"} true;
        if (!$w$loop#0)
        {
            if (LitInt(0) <= index#0)
            {
        ...
        // ----- if statement ----- find.dfy(10,7)
        assert a#0 != null;
        assert 0 <= index#0 && index#0 < _System.array.Length(a#0);
        assume true;
        if ($Unbox(read($Heap, a#0, IndexField(index#0))): int == key#0)
        {
            // ----- return statement ----- find.dfy(10,28)
            return;
        }
        else
        {
        ...
        // ----- assignment statement ----- find.dfy(11,13)
        assume true;
        assume true;
        index#0 := index#0 + 1;
        assume {:captureState "find.dfy(11,24)"} true;
        // ----- loop termination check ----- find.dfy(6,4)
    ...
    // ----- assignment statement ----- find.dfy(13,10)
    assume true;
    assume true;
    index#0 := LitInt(0 - 1);
    assume {:captureState "find.dfy(13,14)"} true;
}
